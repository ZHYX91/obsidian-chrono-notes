...
root = Path(root_arg)
root.mkdir()
archive_name = f"chrono-notes-{version}.zip"
loose = {
    "main.js": b"console.log('safe');\n",
    "manifest.json": json.dumps({"id": "chrono-notes", "version": version}).encode("utf-8"),
...
inner_entries = [
    entry("chrono-notes/main.js", loose["main.js"]),
    entry("chrono-notes/manifest.json", loose["manifest.json"]),
    entry("chrono-notes/styles.css", loose["styles.css"]),
]
if scenario == "inner_duplicate":
    inner_entries.append(entry("chrono-notes/main.js", loose["main.js"]))
elif scenario == "inner_reordered":
    inner_entries.reverse()
elif scenario == "inner_wrong_mode":
    inner_entries[0] = entry("chrono-notes/main.js", loose["main.js"], stat.S_IFREG | 0o755)
elif scenario == "inner_symlink":
    inner_entries[2] = entry("chrono-notes/styles.css", b"main.js", stat.S_IFLNK | 0o777)
elif scenario == "inner_extra_nested":
    inner_entries.append(entry("chrono-notes/nested/extra.txt", b"bad"))
...
outer_entries = [
    entry("SHA256SUMS", "".join(checksum_lines).encode("ascii")),
