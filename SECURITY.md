...
Security fixes are provided for the latest released version of Chrono Notes. A version declared only in source manifests or in the changelog's `Unreleased` section is not a released version.
